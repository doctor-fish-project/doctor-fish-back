...
- 프론트에서 보낸 username, password를 받는다.</br>  
...
- controller에서 보낸 username, password를 받아서 username으로 데이터베이스에서 사용자를 찾고 password로 해당 사용자의 password와 비교를 한다.</br>  
...
- id는 mapper에 있는 findByEmail이고 반환 값은 userResultMap이다.</br> 
